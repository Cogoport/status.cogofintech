...
const Home: NextPage = () => {
  return (
    <div className='h-full w-full '>
      ...
      <div className="w-full h-40 absolute bg-yellow-400 dark:purple dark:bg-black">
        <div className="sm:ml-0 ml-5 mr-0 mt-3 md:pl-80 md:pr-80 sm:w-full h-full bg-yellow-400 dark:bg-black">
